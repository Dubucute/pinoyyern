    ...
    <>
      ...
      <style jsx global>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .machine-detail-close { font-family: 'Press Start 2P', cursive; background: none; color: #e2e8f0; border: 3px solid #4a5568; padding: 0.2rem 0.4rem; font-size: 0.5rem; cursor: pointer; }
        .machine-detail-close:hover { background: #4a5568; }
        .machine-detail-main { display: flex; align-items: center; gap: 1rem; padding: 1rem 1rem 0.5rem; }
        .machine-detail-icon { flex-shrink: 0; }
        .machine-detail-id { flex: 1; }
        .machine-detail-name { color: #ed8936; font-size: 0.6rem; margin-bottom: 0.3rem; }
        .machine-detail-type { color: #4a5568; font-size: 0.4rem; margin-top: 0.2rem; }
        .machine-detail-lv { font-size: 0.8rem; font-weight: bold; text-shadow: 2px 2px 0 #1a202c; flex-shrink: 0; }
        .machine-detail-bars { display: flex; gap: 2px; padding: 0 1rem 1rem; justify-content: center; }
        .machine-detail-bar { width: 16px; height: 8px; border: 1px solid #1a202c; }
        .machine-detail-stats-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 0.5rem; padding: 0 1rem 1rem; }
        .detail-stat-box { background: #1a202c; border: 3px solid #4a5568; padding: 0.6rem; }
        .detail-stat-box.span-2 { grid-column: span 2; }
        .detail-stat-label { color: #a0aec0; font-size: 0.4rem; margin-bottom: 0.4rem; }
        .detail-stat-value { font-size: 0.55rem; font-weight: bold; }
        .detail-stat-value.earnings { color: #48bb78; }
        .detail-stat-value.time { color: #4299e1; }
        .detail-stat-value.income { color: #ed8936; }
        .detail-stat-value.next { color: #68d391; }
        .detail-stat-value.cost { color: #f6e05e; }
        .detail-stat-value.spent { color: #e53e3e; }
        .detail-stat-value.eff { color: #48bb78; }
        .rename-trigger { font-family: 'Press Start 2P', cursive; background: none; color: #4a5568; border: none; cursor: pointer; font-size: 0.5rem; margin-left: 0.3rem; vertical-align: middle; }
        .rename-trigger:hover { color: #a0aec0; }
        .rename-input-group { display: flex; align-items: center; gap: 0.3rem; }
        .rename-input { font-family: 'Press Start 2P', cursive; background: #1a202c; color: #ed8936; border: 3px solid #4a5568; padding: 0.3rem; font-size: 0.4rem; width: 100%; outline: none; }
        .rename-input:focus { border-color: #48bb78; }
        .rename-confirm-btn { font-family: 'Press Start 2P', cursive; background: #48bb78; color: #1a202c; border: 3px solid #38a169; padding: 0.2rem 0.4rem; font-size: 0.35rem; cursor: pointer; flex-shrink: 0; }
        .rename-confirm-btn:hover { background: #68d391; }
        .rename-cancel-btn { font-family: 'Press Start 2P', cursive; background: none; color: #a0aec0; border: 3px solid #4a5568; padding: 0.2rem 0.3rem; font-size: 0.35rem; cursor: pointer; flex-shrink: 0; }
        .rename-cancel-btn:hover { background: #4a5568; }
        .machine-detail-actions { padding: 0 1rem 0.5rem; }
        .detail-upgrade-btn { font-family: 'Press Start 2P', cursive; width: 100%; background: #48bb78; color: #1a202c; border: 4px solid #38a169; padding: 0.6rem; font-size: 0.45rem; cursor: pointer; }
        .detail-upgrade-btn:hover { background: #68d391; }
        .detail-upgrade-btn.disabled { background: #4a5568; color: #718096; border-color: #2d3748; cursor: not-allowed; }
        .detail-max-badge { font-family: 'Press Start 2P', cursive; width: 100%; background: #ed8936; color: #1a202c; padding: 0.6rem; font-size: 0.45rem; border: 4px solid #dd6b20; text-align: center; }
        .machine-detail-sell { padding: 0 1rem 1rem; }
        .sell-button { font-family: 'Press Start 2P', cursive; width: 100%; background: #e53e3e; color: #fff; border: 4px solid #c53030; padding: 0.6rem; font-size: 0.45rem; cursor: pointer; }
        .sell-button:hover { background: #fc8181; }
        .sell-confirm { text-align: center; }
        .sell-confirm-text { color: #f6e05e; font-size: 0.5rem; margin-bottom: 0.5rem; }
        .sell-confirm-actions { display: flex; gap: 0.5rem; justify-content: center; }
        .sell-confirm-yes { font-family: 'Press Start 2P', cursive; background: #e53e3e; color: #fff; border: 4px solid #c53030; padding: 0.5rem 1rem; font-size: 0.5rem; cursor: pointer; flex: 1; }
        .sell-confirm-yes:hover { background: #fc8181; }
        .sell-confirm-no { font-family: 'Press Start 2P', cursive; background: #4a5568; color: #e2e8f0; border: 4px solid #2d3748; padding: 0.5rem 1rem; font-size: 0.5rem; cursor: pointer; flex: 1; }
        .sell-confirm-no:hover { background: #718096; }

        /* ===== Responsive ===== */
        @media (max-width: 768px) {
          .game-header { flex-wrap: wrap; padding: 0.4rem; }
          .game-title { font-size: 0.45rem; }
          .header-stats { order: 3; width: 100%; justify-content: space-around; gap: 0.25rem; }
          .main-content { flex-direction: column; }
          .viewport { border-right: none; border-bottom: 4px solid #48bb78; min-height: 300px; }
          .control-hub { width: 100%; max-height: 50vh; }
          .location-tab { padding: 0.25rem 0.1rem; }
